...
c_true = 1.0
m_true = 2.0
y_true = parabola(x_data, c_true, m_true)
...
least_squares = LeastSquares(x_data, y_data, yerr_data, parabola)
...
plt.plot(x_data, parabola(x_data, *m.values), label="Parabola fit")
