# NewProblem.py 
# Use Bisection with new function.
#
# Demo root finding with slightly more complicated function 
# with multiple roots.
#
import math
import rfArgs
...
def f(x):                               # The function, f(x), whose zero we seek
    f = math.sin(x) + math.sin(5*x) + math.sin(10*x)
    return f
...
rfArgs.showArgs(a,b,tol)                # for bracketing interval (a,b) and 
                                        # tolerance |x - x_root|.
